   ...
   if (sec_m == 5) begin
    ...
    if (min_l == 9) begin
     ...
     if (min_m == 5) begin
      ...
      end else if (hr_m == 2 && hr_l == 3) begin
       hr_m <= 0;
       hr_l <= 0;
      end else begin
       hr_l <= hr_l + 1;
...
function [6:0] seven_seg_decode;
 input [3:0] digit;
 case (digit)
  4'b0000: seven_seg_decode = 7'b1111110;
  4'b0001: seven_seg_decode = 7'b0110000;
  4'b0010: seven_seg_decode = 7'b1101101;
  4'b0011: seven_seg_decode = 7'b1111001;
  4'b0100: seven_seg_decode = 7'b0110011;
  4'b0101: seven_seg_decode = 7'b1011011;
  4'b0110: seven_seg_decode = 7'b1011111;
  4'b0111: seven_seg_decode = 7'b1110000;
  4'b1000: seven_seg_decode = 7'b1111111;
  4'b1001: seven_seg_decode = 7'b1111011;
